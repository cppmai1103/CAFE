...
Working at the span level directly, rules that out: once a span is kept, every candidate
...
Usage:
    ...
    python src/ner/gliner/deduplicate_ner_features.py --ner-features data/ner_features.csv --out data/deduplicate_ner_features.csv --conflicts-out data/ner_overlap_conflicts.json
"""
