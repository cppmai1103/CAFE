...
Usage:
    python analyze_gliner_mismatches.py
    python analyze_gliner_mismatches.py --token-format /tmp/smoke_token_format.csv --figures-dir /tmp/figures
"""
...
DEFAULT_TOKEN_FORMAT = DATA_DIR / "hipe2020_train_fr_gliner_token_format.csv"
...
def main():
    ...
    plot_prf(prf_df, figures_dir / "precision_recall_f1.png")
    print(f"Saved {figures_dir / 'precision_recall_f1.png'}")
    ...
    plot_alignability(align_df, n_gliner_entities, figures_dir / "alignability.png")
    print(f"Saved {figures_dir / 'alignability.png'}")
