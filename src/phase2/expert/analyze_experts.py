...
Usage:
    python src/phase2/expert/analyze_experts.py
    python src/phase2/expert/analyze_experts.py --scores data_phase2_expert/test_results/xlm-roberta_experts_scores.csv --checkpoint checkpoints/phase2_expert/xlm-roberta_experts.pt
    python src/phase2/expert/analyze_experts.py --split ""   # every candidate, not just test
"""
...
from phase2.expert.model import load_model, variant_name
from phase2.expert.train import DEFAULT_CHECKPOINT_OUT

REPO_ROOT = Path(__file__).parent.parent.parent.parent
# Derived from variant_name() (not a hand-typed string) so it can never drift out of sync
# with what train.py/evaluate.py actually name a checkpoint/scores CSV.
DEFAULT_SCORES = REPO_ROOT / "data" / "data_phase2_expert" / "test_results" / f"{variant_name()}_scores.csv"
DEFAULT_FIGURES_DIR = REPO_ROOT / "figures" / "phase2_expert"

# Same visual language as src/phase1/modeling/plot_reliability_diagram.py, reused for consistency
