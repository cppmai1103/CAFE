...
Usage:
    python src/phase2/base/check.py
    python src/phase2/base/check.py --n 5
    python src/phase2/base/check.py --n 3 --split test
"""
...
from phase2.base.dataset import DICT_FLAG_NAMES, SPLITS, TARGET_FLAG_NAMES, Phase2WindowDataset
from phase2.base.tokenize_windows import DEFAULT_ENCODER_NAME
