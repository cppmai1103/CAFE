...
than the already-252MB word-level JSONL
- would need rebuilding every time the encoderchoice changes. 
tokenize_candidate_window() below is written to be imported directly by
...
Usage:
    ...
    python src/phase2/base/tokenize_windows.py --encoder-name camembert-base --max-length 256
    python src/phase2/base/tokenize_windows.py --limit 500 --print-examples 20  # smoke test
"""
...
from phase2.base.vocab import DICT_FLAG_VOCAB, TARGET_FLAG_VOCAB
