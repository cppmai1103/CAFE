...
Usage:
    python src/phase2_expert/train.py
    python src/phase2_expert/train.py --batch-size 32 --lr 3e-4 --max-epochs 30
    python src/phase2_expert/train.py --limit 40 --max-epochs 2 --batch-size 4  # smoke test
    python src/phase2_expert/train.py --num-experts 8 --expert-hidden 128
    python src/phase2_expert/train.py --lambda-balance 0.05   # stronger balancing pressure
    python src/phase2_expert/train.py --lambda-balance 0      # disable load-balancing (old behavior)
"""
...
from phase2_expert.model import (
...
CHECKPOINTS_DIR = Path(__file__).parent.parent.parent / "checkpoints" / "phase2_expert"
DEFAULT_CHECKPOINT_OUT = CHECKPOINTS_DIR / "camembert_experts.pt"
DEFAULT_FIGURES_DIR = Path(__file__).parent.parent.parent / "figures" / "phase2_expert"
