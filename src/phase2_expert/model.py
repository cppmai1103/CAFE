...
Usage (smoke test -- builds a small real batch via phase2.dataset and runs one forward pass):
    python src/phase2_expert/model.py
    python src/phase2_expert/model.py --batch-size 4 --num-experts 4
"""
...
from phase2.model import encoder_short_name
