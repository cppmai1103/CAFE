...
Usage:
    ...
    python src/feature_extraction/extract_context_features.py
    python src/feature_extraction/extract_context_features.py --ner-features /tmp/smoke_ner.csv --out /tmp/smoke_context.csv
"""
